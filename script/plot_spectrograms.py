...
fig_delta_path = delta_path / "figs_pkl" / "DeltaSI-SDR_vs_Noise_inharmonicity_percent_00.pkl"
fig_times_path = times_path / "figs_pkl" / "DeltaSI-SDR_vs_Noise_inharmonicity_percent_00.pkl"
...
figsize_orig = fig_delta.get_size_inches()
figsize_orig[0] = figsize_orig[0] * 2
figsize_orig[1] = figsize_orig[1] * 0.7
new_fig = plt.figure(figsize=figsize_orig, dpi=fig_delta.dpi, constrained_layout=True)
